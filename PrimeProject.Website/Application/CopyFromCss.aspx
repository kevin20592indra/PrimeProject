<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CopyFromCss.aspx.cs" Inherits="PrimeProject.Website.Application._Theme.CopyFromCss" %>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="/Application/_Theme/index2.html" class="logo"><b>Admin</b>LTE</a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="/Application/_Theme/dist/img/user3-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="/Application/_Theme/dist/img/user4-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/Application/_Theme/dist/img/user2-160x160.jpg" class="user-image" alt="User Image"/>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/Application/_Theme/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                <li><a href="/Application/_Theme/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li><a href="/Application/_Theme/documentation/index.html"><i class="fa fa-book"></i> Documentation</a></li>
