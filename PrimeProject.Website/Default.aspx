<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PrimeProject.Website.Default" %>
                    ...
                    <section class="col-lg-7 connectedSortable">
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body chat" id="chat-box">
                                <!-- chat item -->
                                <div class="item">
                                    <img src="/Application/_Theme/dist/img/user4-128x128.jpg" alt="user image" class="online" />
                                    <p class="message">
                                        <a href="#" class="name">
                      ...
                      best themes on the market
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="/Application/_Theme/dist/img/user3-128x128.jpg" alt="user image" class="offline" />
                                    <p class="message">
                                        <a href="#" class="name">
                      ...
                      best themes on the market
                                ...
                                <!-- chat item -->
                                <div class="item">
                                    <img src="/Application/_Theme/dist/img/user2-160x160.jpg" alt="user image" class="offline" />
                                    <p class="message">
                                        <a href="#" class="name">
